...
/**
 * Classe per la view di confronto di suscettibili, infetti e rimossi
...
public class ConfrontoView extends JFrame{
    ...
    private JTextArea risultatiArea = new JTextArea("Confronto nel tempo\n");
    ...
    public ConfrontoView(){
        super("Confronto tra suscettibili, infetti e rimossi");
