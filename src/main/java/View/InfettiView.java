...
public class InfettiView extends JFrame{
     ...
     */
    public InfettiView(){
        super("Andamento della funzione degli infetti");
        ...
        suscettibiliInizialiLabel = new JLabel();
        suscettibiliFinaliLabel = new JLabel();
        tempoTotLabel = new JLabel();
